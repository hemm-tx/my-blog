    ...
    <Template id="tailwindcss-pseudo-class">
      <Template.Content id="tailwindcss-pseudo-class-content">
        <ContentCard title="伪类 伪元素">
          <ContentCard.Paragraph title="伪类" id="tailwindcss-pseudo-class-content-pseudo-class">
          ...
          />
          <ContentCard.Paragraph title="伪元素" id="tailwindcss-pseudo-class-content-pseudo-element">
