    ...
    <Template id="tailwindcss-style-child-element">
      <Template.Content id="tailwindcss-style-child-element-content-container">
        <ContentCard title="样式化子元素">
          <ContentCard.Paragraph id="tailwindcss-style-child-element-child">样式化直接子元素</ContentCard.Paragraph>
          ...
          />
          <ContentCard.Paragraph mt id="tailwindcss-style-child-element-desc">
            样式化后代元素
