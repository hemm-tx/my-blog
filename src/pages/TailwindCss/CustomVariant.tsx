    ...
    <Template id="tailwindcss-custom-variant">
      <Template.Content id="tailwindcss-custom-variant-content">
        <ContentCard title="自定义变体">
          <ContentCard.Paragraph id="tailwindcss-custom-variant-using-custom-variants">使用任意变体</ContentCard.Paragraph>
          ...
          />
          <ContentCard.Paragraph mt id="tailwindcss-custom-variant-custom-variants">
            自定义变体
