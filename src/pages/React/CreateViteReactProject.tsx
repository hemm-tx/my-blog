    ...
    <Template id="create-vite-react-project-content-container">
      ...
      <Template.Content id="configure-project">
        <ContentCard title="配置项目">
          ...
          />
          <ContentCard.Paragraph mt id="configure-project-2">
            创建项目文件夹和文件
          </ContentCard.Paragraph>
          ...
          />
          <ContentCard.Paragraph mt id="configure-project-3">
          ...
          />
          <ContentCard.Paragraph mt id="configure-project-4">
            配置 store 状态管理
          </ContentCard.Paragraph>
          ...
          />
          <ContentCard.Paragraph mt id="configure-project-5">
